		...
		<div class="span9" style="margin-left: 25%;">
			<?php
				if($this->session->flashdata('notification')){
					...
					echo '<div class="alert alert-success"><a class="close" data-dismiss="alert" href="#">x</a>Registration was successful!</div>';
			...
			<div>
				...
				<div class="pull-right">
					<form class="form-search" style="display:inline-block;">
					  <input type="text" class="input-medium" placeholder="search by fullname">
			...
			<ul class="media-list">
				...
				<li class="media">
					<img class="pull-left" alt="pic" src="<?php echo base_url();?>assets/img/pics.png" style="width: 90px; height: 90px;" />
					<div>
